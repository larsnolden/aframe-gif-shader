    ...
    /***/ function (module, exports, __webpack_require__) {
          ...
          AFRAME.registerShader('gif', {
            ...
            schema: {
              ...
              loop: { default: false },  // loop infinitly
              nframes: { default: 20 }, // number of frames to display
              timeInBetween: { default: 0 }, // time in beteween frames
            },
            ...
            __setTexure: function __setTexure(data) {
              ...
              if (data.status === 'error') {
                ...
                var loop = this.__loop;
                data = Object.assign(data, { loop });   //  merge passed this.__ prop with data            
                this.__ready(data);
              }
            },
            ...
            __updateTexture: function __updateTexture(data) {
              ...
              this.__loop = data.loop;
              this.__nframes = data.nframes
              /* autoplay */
            ...
            nextFrame: function nextFrame() {
              ...
              while (Date.now() - this.__startTime >= this.__nextFrameTime) {
                ...
                //stop if nframes is reached
                if(!this.__infinity && (this.__nframes -1 === this.__frameIdx)) {
                  console.log('stop gif')
                  this.pause()
                }
                //loop if nframes is reached
                if ((this.__infinity || this.__loopCnt) && this.__nframes <= this.__frameIdx) {
            ...
            __draw: function __draw() {
              if (this.clearimg) {
                ...
                if(this.__frameIdx < this.__frames.length)this.__ctx.drawImage(this.__frames[this.__frameIdx], 0, 0, this.__width, this.__height);  // issues with accesing non existing frames if()
                this.__texture.needsUpdate = true;
              }
              if (this.clearimg)
                this.clearimg = false;
             ...
             * @param {bool} loop - loop infinitly
             */
            __ready: function __ready(_ref) {
              ...
              cnt ? this.__loopCnt = cnt : this.__infinity = loop;
